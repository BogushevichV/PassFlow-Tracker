...
{
    public partial class RoundRowViewModel : TrackedViewModel
    {
        public int RoundId { get; set; }

        private string _originalUnitName = string.Empty;
        private string _originalStartPoint = string.Empty;
        private string _originalEndPoint = string.Empty;
        ...
        public void SetOriginalValues(int id, string unitName, string startPoint, string endPoint, string timeFrom, string timeTo,
